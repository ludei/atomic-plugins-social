(function() {
    ...
    * @fileOverview
    ...
    <p>This <a src="https://github.com/ludei/atomic-plugins-social">repository</a> contains a Social API designed using the Atomic Plugins paradigm. The API is already available in many languagues and we plan to add more in the future.</p>
    ...
    <ul>
    <code>cordova plugin add cocoon-plugin-social-ios-gamecenter</code><br/>
    <code>cordova plugin add cocoon-plugin-social-android-googleplaygames</code><br/>
    <code>cordova plugin add ccocoon-plugin-social-ios-facebook</code><br/>
    <code>cordova plugin add cocoon-plugin-social-android-facebook</code><br/>
    </ul>
    <h3>Documentation</h3>
    ...
    */
     ...
     * - <a href="http://ludei.github.io/atomic-plugins-docs/dist/doc/js/Cocoon.Social.Facebook.html">Facebook</a>
     * - <a href="http://ludei.github.io/atomic-plugins-docs/dist/doc/js/Cocoon.Social.GooglePlayGames.html">Google Play Games</a>
     * - <a href="http://ludei.github.io/atomic-plugins-docs/dist/doc/js/Cocoon.Social.GameCenter.html">Game Center</a>
    ...
    Cocoon.define("Cocoon.Social", function(extension) {
        ...
        extension.Interface = function() {
            ...
            this.on = this.onLoginStatusChanged.expose();
        ...
        extension.SocialGamingService.prototype = {
             ...
             * @param {Cocoon.Social.ScoreParams} [params] The params to submit the score. If no params are specified, the currently logged in user and the default leaderboard are assumed.
             */
            addScore: function(score, callback, params) {
                callback = callback || function() {};
                var me = this;
                this.requestScore(function(currentScore, error) {
                    if (error) {
                        callback(error);
                        return;
                    }
                    ...
                    me.submitScore(value, callback, params);
                }, params);
            },
